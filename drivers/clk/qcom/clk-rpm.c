...
/* msm8930 */
DEFINE_CLK_RPM(msm8930_afab, QCOM_RPM_APPS_FABRIC_CLK);
DEFINE_CLK_RPM(msm8930_sfab, QCOM_RPM_SYS_FABRIC_CLK);
DEFINE_CLK_RPM(msm8930_mmfab, QCOM_RPM_MM_FABRIC_CLK);
DEFINE_CLK_RPM(msm8930_daytona, QCOM_RPM_DAYTONA_FABRIC_CLK);
DEFINE_CLK_RPM(msm8930_sfpb, QCOM_RPM_SFPB_CLK);
DEFINE_CLK_RPM(msm8930_cfpb, QCOM_RPM_CFPB_CLK);
DEFINE_CLK_RPM(msm8930_mmfpb, QCOM_RPM_MMFPB_CLK);
DEFINE_CLK_RPM(msm8930_ebi1, QCOM_RPM_EBI1_CLK);

static struct clk_rpm *msm8930_clks[] = {
	[RPM_APPS_FABRIC_CLK] = &clk_rpm_msm8930_afab_clk,
	[RPM_APPS_FABRIC_A_CLK] = &clk_rpm_msm8930_afab_a_clk,
	[RPM_SYS_FABRIC_CLK] = &clk_rpm_msm8930_sfab_clk,
	[RPM_SYS_FABRIC_A_CLK] = &clk_rpm_msm8930_sfab_a_clk,
	[RPM_MM_FABRIC_CLK] = &clk_rpm_msm8930_mmfab_clk,
	[RPM_MM_FABRIC_A_CLK] = &clk_rpm_msm8930_mmfab_a_clk,
	[RPM_DAYTONA_FABRIC_CLK] = &clk_rpm_msm8930_daytona_clk,
	[RPM_DAYTONA_FABRIC_A_CLK] = &clk_rpm_msm8930_daytona_a_clk,
	[RPM_SFPB_CLK] = &clk_rpm_msm8930_sfpb_clk,
	[RPM_SFPB_A_CLK] = &clk_rpm_msm8930_sfpb_a_clk,
	[RPM_CFPB_CLK] = &clk_rpm_msm8930_cfpb_clk,
	[RPM_CFPB_A_CLK] = &clk_rpm_msm8930_cfpb_a_clk,
	[RPM_MMFPB_CLK] = &clk_rpm_msm8930_mmfpb_clk,
	[RPM_MMFPB_A_CLK] = &clk_rpm_msm8930_mmfpb_a_clk,
	[RPM_EBI1_CLK] = &clk_rpm_msm8930_ebi1_clk,
	[RPM_EBI1_A_CLK] = &clk_rpm_msm8930_ebi1_a_clk,
};
